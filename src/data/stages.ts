...
export const stages: Stage[] = [
  ...
  },
  {
    ...
    description: '🎵 Агент, ты в звукозаписывающей студии!\n\nНа пульте микшера установлен опорный уровень сигнала: U₀ = 1 В\n\nПеред тобой три аудиозаписи. Каждая запись имеет свой уровень напряжения на осциллографе.\n\n🎧 Твоя задача:\n1. Прослушай каждую запись\n2. Изучи осциллограмму (показывает амплитуду напряжения)\n3. Вычисли относительный уровень в дБ по формуле:\n   L = 20·log₁₀(U/U₀)\n\n⚠️ Важно: громкость записи соответствует уровню сигнала в дБ!',
    audio: 'music_briefing.mp3',
    type: 'audio',
    question: 'Какой уровень сигнала (в дБ) у самой громкой записи?',
    audioUrl: 'music_samples',
    options: [
      { text: '6 дБ', correct: false },
      { text: '12 дБ', correct: true },
      { text: '18 дБ', correct: false },
    ],
    correctFeedback: 'Превосходно! Запись B с напряжением 4 В имеет уровень 20·log₁₀(4/1) = 12 дБ. Это действительно самая громкая запись!',
    incorrectFeedback: 'Не совсем. Прослушай записи, найди самую громкую и вычисли её уровень: L = 20·log₁₀(U/1). Подсказка: U₁=2В, U₂=4В, U₃=3В.',
  },
  {
    id: 9,
